...
# samples = 1000
# batches = 1
# train_dataset  = CreateDataScatter(samples, W1, W2)
# train_scatter_loader = torch.utils.data.DataLoader(train_dataset, batch_size=batches)
# =============================================================================
...
# 
# class ScatNet_CIFAR(torch.nn.Module):
#     def __init__(self):
#         super(ScatNet_CIFAR, self).__init__()
#         self.scat = Scattering2D(J=2, shape=(32, 32), L=8).cuda()
#         
#     def forward(self, x):
#         x = self.scat(x)
#         return x.view(x.shape[0], -1, x.shape[3], x.shape[4])
# 
# model_catter = ScatNet_CIFAR()
# model_catter.cuda()
#     
# class CreateDataScatter(torch.utils.data.Dataset):
...
# =============================================================================
# item = next(iter(train_scatter_loader))
# print(item[1].shape)
# =============================================================================
